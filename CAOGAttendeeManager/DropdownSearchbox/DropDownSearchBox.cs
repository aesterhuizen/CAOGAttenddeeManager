...
public class DropDownSearchBox : ComboTreeBox {
	...
	void _services_ContextMenuOpening(object sender, System.EventArgs e) {
		DropDownControl.AutoClose = false;
	}

	void _services_ContextMenuClosed(object sender, System.EventArgs e) {
		DropDownControl.AutoClose = true;
	}

	void _services_TextChanged(object sender, System.EventArgs e) {
